"""
    This script connects to Twitter Streaming API, gets tweets with relevant hashtags
    ...
    Original Author: Tilemachos Pechlivanoglou
...
consumer_key = '7pIzd9p4Ekn5Iqa1Jm4f5x5DE'
consumer_secret = 'svB49FnMIe4qdPBwsYGWQM3JUd33dRS8bzBzVBlhN6Ddworoxh'
access_token = '1062864839553568769-pz6tPGL3dbMnL8x9j2ipMYp7I6pc9T'
access_token_secret = 'xMeDWfVlnrVErKXH9b5jU7JTiK1V3A3XkGS1n4ZXWdxWn'
...
# setup search terms that match with the chosen tags so that we get relevant data
track = ['#bitcoin' , '#blockchain', '#ai', '#machinelearning', '#cyber' , 'tech','stock','apple','twitter','cryptocurrency', 'facebook' ,'google' '#aapl', '#mac', '#fb', '#facebook', '#bitcoin' , '#blockchain', '#fb', '#facebook', '#youtube', '#googl']
language = ['en']
